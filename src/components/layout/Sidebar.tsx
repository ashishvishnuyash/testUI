                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                onClick={(e) => handleDeleteChat(chatItem.id, e)}
        ...
        <div className="mt-auto p-1 md:p-2 border-t border-sidebar-border">
           ...
           {user && !combinedError && (
               <div className="space-y-1">
                   {/* Subscription Dialog */}
                   <Dialog onOpenChange={(open) => !open && setIsMobileMenuOpen(false)}> {/* Close mobile menu when dialog closes */}
           ...
           <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
               ...
               <SheetContent side="left" className="w-64 p-0 flex flex-col bg-sidebar border-r border-sidebar-border">
                    <VisuallyHidden>
                       ...
                       <SheetDescription>Sidebar menu for navigation and chat management.</SheetDescription>
                    </VisuallyHidden>
                   {sidebarContent}
               </SheetContent>
           </Sheet>
